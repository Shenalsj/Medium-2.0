...
<div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
    ...
    <label className="block mb-5">
        <span className="text-gray-700">Name</span>
          ...
          focus:ring" placeholder="name" type="text"/>                
    </label>
    ...
    <label className="block mb-5">
        <span className="text-gray-700">Email</span>
          ...
          className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none
          focus:ring" placeholder="email" type="email"/>                
    </label>
    ...
    <label className="block mb-5">
        <span className="text-gray-700">Comment</span>
          ...
          className="shadow border py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none
          focus:ring" placeholder="comment" rows={8}/>                
    </label>
